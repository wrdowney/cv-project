    ...
    return (
        <div className="flex flex-col gap-2 mb-4">
            <form className="flex flex-col gap-2 mb-4">
                ...
                <Input type="text" name="description" placeholder="Description" onChange={(e) => onChange(e, id)} value={experience.description}/>
                ...
                <Input type="text" name="city" placeholder="City" onChange={(e) => onChange(e, id)} value={experience.city}/>
